            ...
            <div class="col-md-12">
                <div class="portlet-body form">
                    <div class="pull-right">
                    	<button type="button" class="btn-remark btn-link" data-toggle="modal" data-target="#remarkHistoryModalId" onclick="_paq.push(['trackEvent', 'KYCTemplate', 'ViewRemarks','Viewing remark on auditview template']);" >View Remarks</button>
...
<script>
	...
	$('#closeButton').click(function() {
		_paq.push(['trackEvent', 'KYCTemplate', 'Close','Closing template audit view']);
