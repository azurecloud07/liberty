...
<div class="page-content-wrapper">
    <div class="page-content">
		...
		<form:form action="#" method="POST" id="frm" role="form" class="horizontal-form uk-form bt-flabels js-flabels" modelAttribute="kycTemplateBO" data-parsley-validate="true" data-parsley-errors-messages-disabled="true">
