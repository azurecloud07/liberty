...
<div class="page-content-wrapper">
    <div class="page-content">
            ...
            <div class="col-md-12">
                <div class="portlet-body form">
                    <div class="pull-right">
                    	<button type="button" class="btn-remark btn-link" data-toggle="modal" data-target="#remarkHistoryModalId" onclick="_paq.push(['trackEvent', 'KYCSubject', 'ViewRemarks','Viewing remark on view subject']);" >View Remarks</button>
                    	<button type="button" id="downloadReport" class="btn-itg btn btn-sm grey-gallery">Download Report</button>
                    	   <c:choose>
		                    <c:when test="${nextStates != null && nextStates.length() > 0}">
	                    		...
	                    		<button type="button" id="cancelBtn" class="btn-itg btn btn-sm grey-gallery"><img src="/digiKYC/assets/global/img/clear.png" /> ${cancelLabel}
								</button>
		                    </c:when>
		                    <c:otherwise>
		                    	<button type="button" id="closeButton" class="btn-itg btn btn-sm grey-gallery"><img src="/digiKYC/assets/global/img/clear.png" /> ${closeLabel}
		                        </button>
	                    	</c:otherwise>
	                    </c:choose>
                    </div>
		...
		<input type="hidden" id="kycSubjectRequestNo" value="${kycSubjectBO.kycSubjectRequestNo}" />
		...
		<textarea id="kycViewSchema" style="display:none;">${kycViewSchema}</textarea>
		...
		<c:if test="${isOtherDetails == 'true' && otherDetails.get('isRequestFromNec') == true && kycSubjectBO.typeOfCounterpartyCode != 'Individual'}">
			<div class="row">
				<div class="col-md-12">
							                                    ...
							                                    <c:if test="${docObject.documentReceived == 1}">
							                                        <div class="form-group">
							                                            ...
							                                            <div class="col-md-6">
							                                                <p class="form-control-static doc-name-align">
							                                                    <c:choose>
																				    <c:when test="${empty docObject.comment}"><span>&nbsp;</span></c:when>
																				    <c:otherwise>
			...
			<c:choose>
				<c:when test="${isMitigationWorkflow == 'true'}">
					<c:if test="${screeningData.totalRiskLevel != 'Low' || kycSubjectBO.typeOfCounterpartyCode == 'Entity'}">
			...
			<%-- <c:if test="${screeningData= null}">
				...
				<c:if test="${screeningData.totalRiskLevel != 'Low'}">
					<h3 class="form-section" style="display:none;">Mitigation Details</h3>
					<div class="form-body" style="display:none;">
						<c:forEach begin="0" end="${mitigationObject.size() - 1 }"
							var="mitigationIndex">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<p class="form-control-static doc-name-align">
												${mitigationObject[mitigationIndex].activityPerformed}</p>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<p class="form-control-static doc-name-align">
												${mitigationObject[mitigationIndex].activityDescription}</p>
										</div>
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="col-md-8">
											<c:forEach begin="0"
												end="${mitigationObject[mitigationIndex].mitigationProofList.size() - 1 }"
												var="mitigationProofIndex">
												<c:choose>
...
<script>
	...
	$('#closeButton').click(function() {
		_paq.push(['trackEvent', 'KYCSubject', 'Close','Closing Subject view']);
	...
	$("#btnScreeningDetails").click(function(){
		_paq.push(['trackEvent', 'KYCSubject', 'ScreeningDetails','Viewing screening details on view subject']);
	...
	var showAddRelation = function(relationList){
		...
		var relationGridRows = $('#addRelationGrid').jqxGrid('getrows');
        var relationGridCount = relationGridRows.length;
        if (relationGridCount > 10) {
        	$('#addRelationGrid').jqxGrid({ pageable: true, pagesize: 10 });
       	}
	};
