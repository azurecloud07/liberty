...
<spring:message code="kycSubject.mitigation.file.extensions" var="ocrFileExtensions" />
...
<input type="hidden" value="${ocrFileExtensions}" id="ocrFileExtensionsId" />
                           ...
                           <div class="tab-content">
                              <div class="tab-pane active tab_pane" id="tab1">
                                 ...
                                 <div class="bt-flabels__wrapper">
																	<label class="parsley_hide">Upload Passport</label>
																	<!-- <input type="hidden" name="mitigation.mitigationActivityList[0].mitigationProofList[0].fileId" value= "0"/> -->
																	<input type="file" class="hidden" name="passportFile"
																		id="ocrFile" accept="${ocrFileExtensions}"
																		onchange="javascript:onChangeOCRFile();" />
																	<input type="file" class="hidden" name="mitigation.mitigationActivityList[0].mitigationProofList[0].documentFile" 
																id="ocrFile_0_0" onchange="javascript:onChangeOCRFile('0_0');" accept="${ocrFileExtensions}">
																	<input type="text" readonly="readonly"
																		class="form-control" name="passportFile" id="ocrFile"
																		placeholder="Upload Passport"
																		onchange="javascript:onChangeOCRFile();" />
																</div>
																<button type="button"
																	class="btn-itg-file btn btn-sm grey-gallery"
																	id="ocrFile" value="Change"
																	onclick="$('#ocrFile').click()">
                                    ...
                                    <div class="row">
                                       <div class="col-md-3">
                                        ...
                                        <div class="col-md-2">
                                              <div class="bt-flabels__wrapper">
                                                <label class="parsley_hide">Upload Passport</label>
                                                <input type="file" class="hidden" name="passportFile" id="uploadedPassportFile" accept="${ocrFileExtensions}"
                                                      onchange="onChangeOCRFile();" />
                                                <input type="text" readonly="readonly" class="form-control" name="passportFile" id="ocrFile"
                                                      placeholder="Upload Passport" />
                                         </div>
                                         </div>
                                         <div class="col-md-2">
                                         <button type="button" class="btn-itg-file btn btn-sm grey-gallery" id="ocrFileBrowseBtn" value="Change"
                                                onclick="$('#uploadedPassportFile').click()"> <i class="fa fa-folder-open-o"></i>&nbsp;Browse
                                         </button>
                                         <!-- <button type='button' class='hidden btn-itg-file btn btn-sm grey-gallery' value='Remove' id='removeOCRfile'> <i class='fa fa-trash'></i> </button> -->
                                       </div>
                                       </div>
                                        <div class="row">
                                       <div class="col-md-3">
												...
												<div class="form-group uk-width-1-1">
													<div class="bt-flabels__wrapper">
														...
														<div class="input-group date" data-date-end-date="+0d">
                                                            <form:input type="text" path="dateOfBirth" placeholder="${dateOfBirthLabel}" data-parsley-required="true" class="chk-field form-control birthDatePicker form-control-inline field-background" data-parsley-group="kycSubjectGroup" />
													...
													<div class="bt-flabels__wrapper">
														...
														<div class="parsley_hide">
															<form:select path="countryOfResidencyCode"
																...
																class="chk-option form-control select2me" data-parsley-required="false" data-parsley-group="kycSubjectGroup">
											...
											<div class="bt-form__wrapper">
												<div class="form-group uk-width-1-1">
													<div class="bt-flabels__wrapper">
														...
														<div class="field-background">
															<form:select path="countryOfCitizenshipCode"
													...
													<div class="bt-form__wrapper">
														<div class="form-group uk-width-1-1">
															<div class="bt-flabels__wrapper">
																...
																<input disabled="disabled" id="kycPartyType" type="text" class="form-control" placeholder="KYC Party Type" value="${otherDetails.get('kycPartyType')}"/>
															</div>
														</div>
													</div>
												</div>
                                             ...
                                             <div class="col-md-12">
                                                <c:choose>
                                                         ...
                                                         <div class="uk-width-1-1">
                                                            <div class="bt-flabels__wrapper">
                                                               <div class="row">
                                                                  ...
                                                                  <form:checkbox path="consentList[${consentIndex.index}].isConsentChecked" value="true" autocomplete="off" required="required" data-parsley-group="kycSubjectGroup" />
                                                   ...
                                                   <c:otherwise>
                                                      <div class="row">
                                                         <form:hidden path="consentList[${consentIndex.index}].consentId" value="${consentObject.consentId}" />
                                                         <form:checkbox path="consentList[${consentIndex.index}].isConsentChecked" value="true" autocomplete="off" data-parsley-group="kycSubjectGroup" />
                                                         <label class="control-label">${consentObject.consentDescription}</label>
                                                      </div>
                                                   </c:otherwise>
                                                </c:choose>
                                 ...
                                 <div class="portlet">
                                    <div class="portlet-body form">
                                       <div class="form-body">
                                          ...
                                          <c:if test="${instanceName == 'FCH'}">
                                          		<div class="pull-right">
		                                       	  <div class='row' id='requestDocumentDiv'>
		                                             <div class='col-md-2'>
