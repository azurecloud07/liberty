...
<c:set var="workFlowPendingSubmission" value="<%= ITGConstant.KYC_SUBJECT_PENDING_SUBMISSIONS%>" />
...
<spring:message code="delete.label" var="deleteLabel" />
...
<spring:message code="app.isParsleyValidation" var="isParsleyValidation" />
         ...
         <div class="col-md-12">
            <div class="portlet-body form">
               <div class="pull-right">
                  ...
                  <button type="button" id="downloadReport" class="btn-itg btn btn-sm grey-gallery">Download Report</button>
                  ...
                  <c:choose>
                    ...
                    <c:otherwise>
                 	...
                 	<button type="button" id="saveKycButton" class="btn-itg btn btn-sm grey-gallery"><img src="/digiKYC/assets/global/img/save.png" /> ${saveLabel} </button>
                  	...
                  	<c:if test="${kycSubjectBO.isActive == 0 && kycSubjectBO.workflowStatus eq workFlowPendingSubmission && !isRequestFromExt && isOnlyNewReq && isCreatedBySameUser}">
						<button type="button" id="deleteKycButton" class="btn-itg btn btn-sm grey-gallery">${deleteLabel}</button>
					</c:if>
            ...
            <div class="portlet" id="form_wizard_1">
               <div class="portlet-body form">
                  <form:form id="frm" class="form-horizontal uk-form bt-flabels js-flabels" action="${contextPath}/kyc/subject/reviewAdd" role="form" method="POST" modelAttribute="kycSubjectBO" data-parsley-validate="true" data-parsley-errors-messages-disabled="true" enctype="multipart/form-data">
                     <input type="hidden" id="isOGSCategoryChanged" value="${kycSubjectBO.OGSCategoryChanged}" />
                     ...
                     <input type="hidden" id="isParsleyValidation" value="${isParsleyValidation}" />
                     ...
                     <input type="hidden" id="emsRefId" value="${kycSubjectBO.emsRefId}" />
                              ...
                              <div class="tab-pane active tab_pane" id="tab1">
                                 ...
                                 <div class="form-body">
                                             ...
                                             <div class="form-group uk-width-1-1">
                                                <div class="bt-flabels__wrapper">
                                                   ...
                                                   <div class="field-background">
                                                      <form:select path="typeOfCounterpartyCode" class="form-control select2me" placeholder="${counterPartyTypeLabel}" data-parsley-required="true" data-parsley-group="singleForm">
                                                         <option value=""></option>
											...
											<div class="bt-form__wrapper">
												<div class="form-group uk-width-1-1">
													<div class="bt-flabels__wrapper">
														...
														<form:input type="text" path="sourceOfWealth" class=" form-control" placeholder="${sourceOfWealthLabel}" maxlength="${maxLength255}"/>
														<span class="bt-flabels__error-desc">Required</span>
													</div>
                                          ...
                                          <div class="bt-form__wrapper">
                                             <div class="form-group uk-width-1-1">
                                                <div class="bt-flabels__wrapper">
                                                   ...
                                                   <form:input path="fullNameOfTargetedContact" placeholder="${fullNameOfTargetedContactLabel}" class="form-control contactDetails" value="" maxlength="${maxLength255}" data-parsley-required="false" data-parsley-group="singleForm" disabled="true" />
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                          ...
                                          <div class="parsley_hide">
                                             <div class="form-group uk-width-1-1">
                                                <div class="bt-flabels__wrapper">
                                                   ...
                                                   <form:input path="addressOfTargetedContact" placeholder="${addressOfTargetedContactLabel}" class="form-control contactDetails" value="" data-parsley-required="false" data-parsley-group="singleForm" disabled="true" />
                                                   <span class="bt-flabels__error-desc">Required</span>
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="bt-form__wrapper">
                                             <div class="form-group uk-width-1-1">
                                                <div class="bt-flabels__wrapper">
                                                   ...
                                                   <div class="parsley_hide">
                                                      <form:select path="nationalityOfTargetedContact" placeholder="${nationalityOfTargetedContactLabel}" class="form-control select2me contactDetails"  data-parsley-group="singleForm" disabled="true">
                                                         <form:option value=""></form:option>
                                                         <c:if test="${nationalityData != null && nationalityData.length() > 0}">
                                                            <c:forEach begin="0" end="${nationalityData.length() -1}" var="index">
                                                               <form:option value="${nationalityData.get(index).get(nationalityShortCode)}">${nationalityData.get(index).get(nationalityName)}</form:option>
                                          ...
                                          <div class="bt-form__wrapper">
                                             <div class="form-group uk-width-1-1">
                                                <div class="bt-flabels__wrapper">
                                                   ...
                                                   <form:input path="emailAddressOfTargetedContact" class="form-control contactDetails" placeholder="${emailAddressOfTargetedContactLabel}" maxlength="${maxLength255}" data-parsley-required="false" data-parsley-group="singleForm" disabled="true" />
                                                   <span class="bt-flabels__error-desc">Required</span>
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="bt-form__wrapper">
                                             <div class="form-group uk-width-1-1">
                                                <div class="bt-flabels__wrapper">
                                                   ...
                                                   <form:input path="phoneNumberOfTargetedContact" class="form-control contactDetails" placeholder="${phoneNoOfTargetedContactLabel}" maxlength="${maxLength255}" data-parsley-required="false" data-parsley-group="singleForm" disabled="true" />
                                                   <span class="bt-flabels__error-desc">Required</span>
                                                </div>
                                             </div>
                                          </div>
                                    ...
                                    <c:if test="${isRelationList == 'true'}">
                                    	<div class="row addRelationClass" style="display:none;">
                                     	...
                                     	<div class="row addRelationClass" style="display:none;">
                                        	<input type="button" class="btn-itg btn btn-sm grey-gallery ogs-field ems-field" style="padding:0px 10px 0px 10px;" id="addrowbutton" value="Add new row" />
                                        	<input type="button" class="btn-itg btn btn-sm grey-gallery ogs-field ems-field" style="padding:0px 10px 0px 10px;" id="deleterowbutton" value="Delete selected row"/>
                                     	</div>
                                             ...
                                             <div class="col-md-12">
                                                <c:choose>
                                                         ...
                                                         <div class="uk-width-1-1">
                                                            <div class="bt-flabels__wrapper">
                                                               <div class="row">
                                                                  ...
                                                                  <form:checkbox class="ogs-field" path="consentList[${consentIndex.index}].isConsentChecked" autocomplete="off" data-parsley-required="true" data-parsley-group="singleForm" />
                                                   ...
                                                   <c:otherwise>
                                                      <div class="row">
                                                         <form:hidden path="consentList[${consentIndex.index}].consentId" value="${consentObject.consentId}" />
                                                         <form:checkbox class="ogs-field" path="consentList[${consentIndex.index}].isConsentChecked" autocomplete="off" data-parsley-group="singleForm" />
                                                         <label class="control-label">${consentObject.consentDescription}</label>
                                                      </div>
                                                   </c:otherwise>
                                                </c:choose>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12" align="center">
                                       ...
                                       <div class="portlet-body form">
                                          	<button type="button" id="manualScreening" class="btn-itg btn btn-sm grey-gallery ogs-field">
	                                            <em class="fa fa-file-code-o"></em> Manual screening
	                                        </button>
                                                   ...
                                                   <div class="col-md-2">
                                                      <div class="radio-list">
                                                         <c:choose>
                                                            ...
                                                            <c:otherwise>
                                                               <label class="radio-inline "> <input class="riskElement" type="radio" value="true" name="kycSubjectReview.isRegulatoryEnforcement"> Yes </label>
												...
												<div class="col-md-12">
												    <div class="portlet-body">
												        <div class="abc" style="margin-left: -31px; margin-right: 157px;">
												            ...
												            <div class="col-md-3"><label class="bold">${isDocumentConfigCheckBoxByLabel} :&nbsp;&nbsp;</label><label id="clickedName">${kycSubjectBO.documentConfigCheckBoxCheckedBy}</label></div>
												            <div class="col-md-3"><label class="bold">${isDocumentConfigCheckBoxDateLabel} :&nbsp;&nbsp;</label><label id="clickedTimestamp">${kycSubjectBO.documentConfigCheckBoxCheckedDate}</label></div>
												        </div>
												    </div>
												</div>
											</div>
				                                                 ...
				                                                 <div class="bt-flabels__wrapper">
				                                                    <label class="parsley_hide">Mitigation Risk Level</label>
				                                                      <select name="mitigation.mitigationRiskLevel" id="mitigationRiskLevel" class="form-control select2me riskElement" data-parsley-required="false" data-parsley-group="kycSubjectMitigationGroup">
				                                                         ...
				                                                         <c:if test="${riskCategoryData != null && riskCategoryData.length() > 0}">
				                                                            <c:forEach begin="0" end="${riskCategoryData.length() -1}" var="index">
				                                                               <option value="${riskCategoryData.get(index).get(riskCategoryShortCode)}"
				                                                               ${riskCategoryData.get(index).get('RiskCategory_shortcode') == kycSubjectBO.mitigation.mitigationRiskLevel ? 'selected="selected"' : '' }>${riskCategoryData.get(index).get(riskCategoryName)}</option>
				                                                            </c:forEach>
				                                                         </c:if>
				                                                      </select>
				                                                 </div>
		                                       		...
		                                       		<div class="bt-form__wrapper">
		                                       			<div class="form-group uk-width-1-1">
		                                       				<div class="bt-flabels__wrapper">
																...
																<input type="text" name="mitigation.mitigationComment" id="mitigationComment" class="form-control" placeholder="Mitigation Comment" data-parsley-required="false" data-parsley-group="kycSubjectMitigationGroup" maxlength="255" value="${kycSubjectBO.mitigation.mitigationComment}"  />
															</div>
														</div>
													</div>
											     </div>
					    ...
					    <div class="modal-dialog modal-lg" style="width: 90%;">
					        <div class="modal-content">
					            <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" onclick="closeScreening()">&times;</button>
												...
												<div class="col-md-12"> -->
													<%-- <c:choose>
														<c:when test="${kycSubjectBO.typeOfCounterpartyCode == 'Individual'}">
															...
															<label class="control-label col-md-2 bold">${countryOfResidencyLabel}:</label>
															<div class="col-md-2">
					            ...
					            <div class="modal-footer">
                                     ...
                                     <button type="button" class="btn-popup btn btn-sm" onclick="closeScreening()" data-dismiss="modal">
				  ...
				  <!-- Duplitcate records modal -->
                     <div id="duplicateRecordsModalId" class="modal fade modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" data-backdrop="static" data-keyboard="false" aria-hidden="true">
					    <div class="modal-dialog modal-lg" style="width: 90%;">
					        <div class="modal-content">
					            ...
					            <div class="modal-footer">
					                <button type="button" class="btn-itg btn-sm grey-gallery" data-dismiss="modal"> Continue <img src="/digiKYC/assets/global/img/forward.png" />
			                        </button>
					            </div>
					        </div>
					    </div>
					...
					<!-- Start Compare KYC Subject Modal -->
					<div id="compareSubjectModal" class="modal fade modal-md" tabindex="-1" role="dialog" aria-hidden="true">
                     <div class="modal-dialog modal-md">
                        <div class="modal-content">
                           <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                              <h4 class="modal-title">Compare KYC Subject Details</h4>
                           </div>
                           <div class="modal-body">
                              <div id="compareSubjectDiv"></div>
                           </div>
                           <div class="modal-footer">
                              <button type="button" class="btn-modal-cls btn-sm default" data-dismiss="modal"><img src="/digiKYC/assets/global/img/clear.png" /> Close
                              </button>
...
<script src="${contextPath}/master/kycSubject/editKycSubject.js?v=1.2" type="text/javascript"></script>
...
<script>
	...
	$("#screeningResultModalId").on("hidden.bs.modal", function () {
	...
	jQuery(document).ready(function() {
	    ...
	    try{
	    	$.each(oldRelation, function(index, relationObject) {
	    		var isOGSCategoryChanged = $("#isOGSCategoryChanged").val();
	    		if(isOGSCategoryChanged == "true"){
	    			relationObject.action = '<a class="btn btn-xs tooltips ems-field" disabled id="btnEditRelation" title="Edit"><img src="/digiKYC/assets/global/img/edit.png"></a>';
	    		}else{
	    			if(isEMSKYC != null)
	    				relationObject.action = '<a class="btn btn-xs tooltips ems-field" disabled id="btnEditRelation" title="Edit"><img src="/digiKYC/assets/global/img/edit.png"></a>';
	    			else
	    				relationObject.action = '<a class="btn btn-xs tooltips ems-field" id="btnEditRelation" title="Edit"><img src="/digiKYC/assets/global/img/edit.png"></a>';
	    		}	
		    });
	    }catch(err){
	    	console.log(err.message);
	...
	$("#downloadReport").click(function(){
		...
		searchObject.subjectId = $("#kycSubjectRequestNo").val();
