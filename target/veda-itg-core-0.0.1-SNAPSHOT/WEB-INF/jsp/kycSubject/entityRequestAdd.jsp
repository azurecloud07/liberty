                                          ...
                                          <div class="bt-form__wrapper">
                                             <div class="form-group uk-width-1-1">
                                                <div class="bt-flabels__wrapper">
                                                   ...
                                                   <form:input type="text" path="registrationNumber" class="form-control field-background" placeholder="${registrationNumberLabel}" maxlength="${maxLength20}" data-parsley-group="kycSubjectGroup" />
                                                   <span class="bt-flabels__error-desc">Required</span>
                                                </div>
                                             ...
                                             <div class="form-group uk-width-1-1">
                                                <div class="bt-flabels__wrapper">
                                                   ...
                                                   <div class="input-group" data-date-end-date="+0d">
                                                      <form:input type="text" path="dateOfIncorporation" placeholder="${dateOfIncorpLabel}" class="form-control form-control-inline datePicker" data-parsley-group="kycSubjectGroup" />
                                          ...
                                          <div class="form-group uk-width-1-1">
                                             <div class="bt-flabels__wrapper">
                                                ...
                                                <form:input type="text" maxlength="${maxLength255}" path="residentialAddress"
                                                   class="form-control" placeholder="${addressLabel}" data-parsley-group="kycSubjectGroup" />
                                                <span class="bt-flabels__error-desc">Required</span>
                                             </div>
                                             ...
                                             <div class="form-group uk-width-1-1">
                                                <div class="bt-flabels__wrapper">
                                                   ...
                                                   <form:input type="text" path="stateCity"
                                                      class="form-control" placeholder="${stateCityLabel}" maxlength="${maxLength255}" data-parsley-group="kycSubjectGroup" />
                                                   <span class="bt-flabels__error-desc">Required</span>
                                                </div>
                                             ...
                                             <div class="form-group uk-width-1-1">
                                                <div class="bt-flabels__wrapper">
                                                   ...
                                                   <form:input type="text" path="zipCode"
                                                      class="form-control" placeholder="${zipCodeLabel}" maxlength="${maxLength15}" data-parsley-group="kycSubjectGroup" />
                                                   <span class="bt-flabels__error-desc">Required</span>
                                                </div>
...
<script>
	...
	$(document).on('click','#btnEditRelation',function(){
		_paq.push(['trackEvent', 'KYCSubject', 'EditRelation', 'Adding relation in KYC Subject.']);
		updateFlag = true;
