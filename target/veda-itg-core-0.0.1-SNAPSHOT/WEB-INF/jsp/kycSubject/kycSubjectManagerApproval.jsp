			...
			<div class="col-md-12">
				<div class="portlet-body form">
					<div class="pull-right">
						<c:choose>
							<c:when test="${screeningData.totalRiskLevel == 'Low' || screeningData.totalRiskLevel == 'Medium' || screeningData.totalRiskLevel == 'High'}">
								<button type="button" class="btn-remark btn-link" data-toggle="modal" data-target="#remarkHistoryModalId" onclick="_paq.push(['trackEvent', 'KYCSubject', 'Remarks','Viewing remark on manager approval']);" >Remark</button>
							</c:when>
							<c:otherwise>
								<button type="button" class="btn-remark btn-link" data-toggle="modal" data-target="#remarkHistoryModalId" onclick="_paq.push(['trackEvent', 'KYCSubject', 'Remarks','Viewing remark on manager approval']);" >Remark</button>
							</c:otherwise>
						      ...
						      <c:forEach begin="0" end="${nextStates.length() -1}" var="index">
						         <c:choose>
						            <c:when test="${nextStates.get(index).getString('Label') == 'Approve'}">
						               <button type="button" class="btn-itg btn btn-sm grey-gallery" data-toggle="modal" data-target="#remarkModalApproveId" onclick="_paq.push(['trackEvent', 'KYCSubject', 'Approve','Approving from manager approval']);"  >
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="portlet" id="form_wizard_1">
                    <div class="portlet-body form">
                      	 <form:form id="frmMain" modelAttribute="subjectManagerApprovalBO" class="form-horizontal uk-form bt-flabels js-flabels" action="${contextPath}/kyc/subject/managerApproval" method="POST" data-parsley-validate="true" data-parsley-errors-messages-disabled="true">
                      	 	<input type="hidden" id="subjectId" value="${subjectJson.id}" />
							...
							<input type="hidden" id="typeOfCounterTypeParty" value="${subjectJson.typeOfCounterpartyCode}" />
							<input type="hidden" id="itgJurisdictionCodeId" value="${subjectJson.itgJurisdictionCode}" />
                                    ...
                                    <div class="tab-content">
				                                                                	...
				                                                                	<c:choose>
				                                                                		<c:when test="${isNewKYCRequest == 'true'}">
																							<c:choose>
																								...
																								<c:otherwise>
																									<c:choose>
																								       	<c:when test="${kycViewSchema.get('OtherDetails').get(index).get('kycNecRequest') == false}">
																								           	<label class="control-label col-md-6 bold">${kycViewSchema.get('OtherDetails').get(index).get('title')} :</label>
										                                                                    <div class="col-md-6">
										                                                                        <p class="form-control-static doc-name-align">
										                                                                        	<c:choose>
                                                    ...
                                                    <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="radio-list">
                                                                 <c:choose>
                                                                	...
                                                                	<%--  <label class="radio-inline ">
																		<form:radiobutton value="1" onclick="riskChanged('pep');" path="isPepRisk" /> Yes
																	</label>
																	<label class="radio-inline">
																		<form:radiobutton value="0" onclick="riskChanged('pep');" path="isPepRisk" /> No
																	</label>  --%>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1"></div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="bt-flabels__wrapper">
                                                                            ...
                                                                            <div class="field-background">
	                                                                            <form:select path="pepRiskLevel" id="pepRiskLevel" onclick="riskChanged('pep');" data-parsley-required="true" class="form-control select2me"  placeholder="Risk Level" >
                                                             ...
                                                             <%-- <div class="col-md-3" hidden>
																<div class="bt-form__wrapper">
																	<div class="bt-flabels__wrapper">
																		...
																		<form:input path="pepRiskRemark" type="text" id="pepRemarkId"	class="form-control field-background" placeholder="Remark" data-parsley-required="false" maxlength="255" />
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="radio-list">
                                                                 <c:choose>
                                                                	...
                                                                	<%--  <label class="radio-inline ">
																		<form:radiobutton value="1" onclick="riskChanged('sanctions');" path="isSanctionRisk" /> Yes
																	</label>
																	<label class="radio-inline">
																		<form:radiobutton value="0" onclick="riskChanged('sanctions');" path="isSanctionRisk" /> No
																	</label>  --%>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1"></div>
                                                                ...
                                                                <div class="bt-form__wrapper">
                                                                    <div class="form-group">
                                                                        <div class="bt-flabels__wrapper">
                                                                            <label class="parsley_hide">Risk Level</label>
                                                                            <div class="field-background">
                                                                                <form:select path="sanctionsRiskLevel" id="sanctionsRiskLevel" onclick="riskChanged('sanctions');" data-parsley-required="true" class="form-control select2me"  placeholder="Risk Level" >
                                                                                	<%-- <form:option value=""></form:option> --%>
			                                                                            <c:if test="${riskCategoryData != null && riskCategoryData.length() > 0}">
																							<c:forEach begin="0" end="${riskCategoryData.length() - 1 }" var="index">
																								<form:option value="${riskCategoryData.get(index).get(riskCategoryShortCode)}" >${riskCategoryData.get(index).get(riskCategoryName)}</form:option>
                                                            ...
                                                            <%--  <div class="col-md-3" hidden>
																<div class="bt-form__wrapper">
																	<div class="bt-flabels__wrapper">
																		<label class="parsley_hide">Remark</label>
																		<form:input path="sanctionRiskRemark" type="text" id="sanRemarkId"	class="form-control field-background" placeholder="Remark" data-parsley-required="false" maxlength="255" />
																		<span class="bt-flabels__error-desc">Required</span>
																	</div>
																</div>
															</div> --%>
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="radio-list">
                                                                 <c:choose>
                                                                	...
                                                                	<%--  <label class="radio-inline ">                                                                	
																		<form:radiobutton value="1" onclick="riskChanged('activities');" path="isActivitiesRisk" /> Yes
																	</label>
																	<label class="radio-inline">
																		<form:radiobutton value="0" onclick="riskChanged('activities');" path="isActivitiesRisk" /> No
																	</label>  --%>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1"></div>
                                                            ...
                                                            <div class="col-md-2" hidden>
                                                                <div class="bt-form__wrapper">
                                                                    <div class="form-group">
                                                                        <div class="bt-flabels__wrapper">
                                                                            <label class="parsley_hide">Risk Level</label>
                                                                            <div class="field-background">
                                                                                <form:select path="activitiesRiskLevel" id="activitiesRiskLevel" onclick="riskChanged('activities');" data-parsley-required="true" class="form-control select2me"  placeholder="Risk Level" >
                                                                                    <%-- <form:option value=""></form:option> --%>
		                                                                            <c:if test="${riskCategoryData != null && riskCategoryData.length() > 0}">
																						<c:forEach begin="0" end="${riskCategoryData.length() - 1 }" var="index">
																							<form:option value="${riskCategoryData.get(index).get(riskCategoryShortCode)}" >${riskCategoryData.get(index).get(riskCategoryName)}</form:option>
                                                             ...
                                                             <%-- <div class="col-md-3" hidden>
																<div class="bt-form__wrapper">
																	<div class="bt-flabels__wrapper">
																		<label class="parsley_hide">Remark</label>
																		<form:input path="activitiesRiskRemark" type="text" id="actRemarkId"	class="form-control field-background" placeholder="Remark" data-parsley-required="false" maxlength="255" />
																		<span class="bt-flabels__error-desc">Required</span>
																	</div>
																</div>
															</div> --%>
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="bt-form__wrapper">
                                                                    <div class="form-group">
                                                                        <div class="bt-flabels__wrapper">
                                                                            <label class="parsley_hide">Risk Level</label>
                                                                            <div class="field-background">
                                                                                <form:select path="countryRiskLevel" id="countryRiskLevel" onclick="riskChanged('country');" data-parsley-required="true" class="form-control select2me"  placeholder="Risk Level" disabled="true">
                                                                                    <form:option value=""></form:option>
		                                                                            <c:if test="${riskCategoryData != null && riskCategoryData.length() > 0}">
																						<c:forEach begin="0" end="${riskCategoryData.length() - 1 }" var="index">
																							<form:option value="${riskCategoryData.get(index).get(riskCategoryShortCode)}" >${riskCategoryData.get(index).get(riskCategoryName)}</form:option>
															...
															<div class="bt-form__wrapper">
																<div class="bt-flabels__wrapper">
																	<label class="parsley_hide">Remark</label>
																	<form:input path="countryRiskRemark" type="text" id="countryRemarkId"	class="form-control field-background" placeholder="Remark" 
																	data-parsley-required="true" maxlength="255" />
																	<span class="bt-flabels__error-desc">Required</span>
																</div>
															</div>
														</div> --%>
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="bt-form__wrapper">
                                                                    <div class="form-group">
                                                                        <div class="bt-flabels__wrapper">
                                                                            <label class="parsley_hide">Risk Level</label>
                                                                            <div class="field-background">
                                                                                <form:select path="totalRiskLevel" id="totalRiskLevel" onclick="riskChanged('totalRisk')" data-parsley-required="true" class="form-control select2me"  placeholder="Risk Level" disabled="true">
                                                                                    <form:option value=""></form:option>
		                                                                            <c:if test="${riskCategoryData != null && riskCategoryData.length() > 0}">
																						<c:forEach begin="0" end="${riskCategoryData.length() - 1 }" var="index">
																							<form:option value="${riskCategoryData.get(index).get(riskCategoryShortCode)}" >${riskCategoryData.get(index).get(riskCategoryName)}</form:option>
															...
															<div class="bt-form__wrapper">
																<div class="bt-flabels__wrapper">
																	<label class="parsley_hide">Remark</label>
																	<form:input path="totalRiskRemark" type="text" id="totalRemarkId" class="form-control field-background" placeholder="Remark" 
																	data-parsley-required="true" maxlength="255" />
																	<span class="bt-flabels__error-desc">Required</span>
																</div>
															</div>
                                        ...
                                        <c:choose>
											<c:when test="${isMitigationWorkflow == 'true'}">
												<c:if test="${screeningData.totalRiskLevel != 'Low' || subjectJson.typeOfCounterpartyName == 'Entity'}">
								    ...
								    <div class="modal-dialog modal-md">
								        <div class="modal-content">
								                    ...
								                    <div class="col-md-12">
								                            <div class="bt-flabels__wrapper">
								                            	<div class="uk-width-1-1">
																	<div class="bt-flabels__wrapper">
										                                <label class="parsley_hide">Remark</label>
										                                <form:textarea path="managerApprovalRemark" id="managerApprovalRemark" rows="15" style="height: 140px;width: 567px;" data-parsley-required="false" placeholder="Remark"></form:textarea>
										                                <span class="bt-flabels__error-desc">Required</span>
										                            </div>
										                            <form:errors path="managerApprovalRemark" cssClass="help-block error" />
										                       	</div>
								                            </div>
								                    </div>
								                </div>
								            ...
								            <div class="modal-footer">
								                <button type="button" class="btn-modal-cls btn btn-sm grey-gallery" data-dismiss="modal" onclick="submitData('${contextPath}');">
								                ...
								                <div class="row">
								                    <div class="col-md-12">
								                            <div class="bt-flabels__wrapper">
								                            	<div class="uk-width-1-1">
																	<div class="bt-flabels__wrapper">
										                                <textarea id="remarkContent" rows="15" style="height: 140px;width: 567px;" data-parsley-required="true" placeholder="Remark"></textarea>
										                                <span class="bt-flabels__error-desc">Required</span>
										                            </div>
										                       	</div>
								                            </div>
...
<script>
	jQuery(document).ready(function() {
		...
		// setting remarks by default disabled
		$('#pepRemarkId').attr('disabled', true);
		$('#pepRemarkId').attr('data-parsley-required', 'false');
		
		$('#sanRemarkId').attr('disabled', true);
		$('#sanRemarkId').attr('data-parsley-required', 'false');
		
		$('#actRemarkId').attr('disabled', true);
		$('#actRemarkId').attr('data-parsley-required', 'false');
		
		$('#countryRemarkId').attr('disabled', true);
		$('#countryRemarkId').attr('data-parsley-required', 'false');
		
		$('#totalRemarkId').attr('disabled', true);
		$('#totalRemarkId').attr('data-parsley-required', 'false');
	...
	function submitData(contextPath) {
		...
		if (!response)
			...
			$('#countryRiskLevel').attr("disabled", false);   
            $('#totalRiskLevel').attr("disabled", false);
			$('#frmMain').submit();
	...
	function riskChanged(type) {
		var riskData = JSON.parse($("#riskDataId").val());
		if(riskData != null){
			var isPepRisk = 0;
			var isSanctionsRisk = 0;
			var isActivitiesRisk = 0;
			
			if(riskData.isPepRisk == true)
				isPepRisk = 1;
			
			if(riskData.isSanctionsRisk == true)
				isSanctionsRisk = 1;
			
			if(riskData.isActivitiesRisk == true)
				isActivitiesRisk = 1;
			
			if(type == "pep"){
				if(($("#pepRiskLevel").val() != riskData.pepRiskLevel) || $('input[name=isPepRisk]:checked').val() != isPepRisk){
					$('#pepRemarkId').attr('disabled', false);
					$('#pepRemarkId').attr('data-parsley-required', 'true');
				}else{
					$('#pepRemarkId').val("");
					$('#pepRemarkId').trigger('change');
					$('#pepRemarkId').attr('disabled', true);
					$('#pepRemarkId').attr('data-parsley-required', 'false');
				}
			}else if(type == "sanctions"){
				if(($("#sanctionsRiskLevel").val() != riskData.sanctionsRiskLevel) || ($('input[name=isSanctionRisk]:checked').val() != isSanctionsRisk)){
					$('#sanRemarkId').attr('disabled', false);
					$('#sanRemarkId').attr('data-parsley-required', 'true');
				}else{
					$('#sanRemarkId').val("");
					$('#sanRemarkId').trigger('change');
					$('#sanRemarkId').attr('disabled', true);
					$('#sanRemarkId').attr('data-parsley-required', 'false');
				}
			}else if(type == "activities"){
				if(($("#activitiesRiskLevel").val() != riskData.activitiesRiskLevel) || ($('input[name=isActivitiesRisk]:checked').val() != isActivitiesRisk)){
					$('#actRemarkId').attr('disabled', false);
					$('#actRemarkId').attr('data-parsley-required', 'true');
				}else{
					$('#actRemarkId').val("");
					$('#actRemarkId').trigger('change');
					$('#actRemarkId').attr('disabled', true);
					$('#actRemarkId').attr('data-parsley-required', 'false');
				}
			}else if(type == "country"){
				if($("#countryRiskLevel").val() != riskData.countryRiskLevel){
					$('#countryRemarkId').attr('disabled', false);
					$('#countryRemarkId').attr('data-parsley-required', 'true');
				}else{
					$('#countryRemarkId').val("");
					$('#countryRemarkId').trigger('change');
					$('#countryRemarkId').attr('disabled', true);
					$('#countryRemarkId').attr('data-parsley-required', 'false');
				}
			}else if(type == "totalRisk"){
				if($("#totalRiskLevel").val() != riskData.totalRiskLevel){
					$('#totalRemarkId').attr('disabled', false);
					$('#totalRemarkId').attr('data-parsley-required', 'true');
				}else{
					$('#totalRemarkId').val("");
					$('#totalRemarkId').trigger('change');
					$('#totalRemarkId').attr('disabled', true);
					$('#totalRemarkId').attr('data-parsley-required', 'false');
				}
				getTemplateDetails();
								...
								usedDocumentCount++;
									usedDiv = usedDiv +"<div class='panel panel-default'>"
														 ...
														 usedDiv =usedDiv +"<label class='control-label col-md-6 bold'>"+attributList[k].documentAttributeName+"</label>"
																	...
																	var referenceNumber = "&nbsp;"
																	if(documentList[j].referenceNumber!="")
																		referenceNumber = documentList[j].referenceNumber;
																	var comment = "&nbsp;"
																	if(documentList[j].comment!="")
